...
import { appReducer, createInitialState, type PaneRuntimeState } from "gloomberb/test-support";
...
import { createTestDataProvider } from "gloomberb/test-support";
...
import { getSharedMarketData, setSharedMarketDataForTests, setSharedRegistryForTests } from "gloomberb/test-support";
import { AI_SCREENER_PANE_STATE_KEY, AiScreenerPane } from "./pane";
import { createScreenerTab, EMPTY_PANE_STATE, type PersistedAiScreenerPaneState } from "./model";
...
import { TestPaneProvider, createTestTicker as makeTicker } from "gloomberb/test-support";
...
describe("AiScreenerPane", () => {
  test("migrates legacy global tabs into pane-local state", async () => {
    ...
    expect(runtime.getResumeState<PersistedAiScreenerPaneState>("ai", `screener-pane:${PANE_ID}`, 1))
